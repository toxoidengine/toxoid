...
var wasmBinaryFile;
if (Module['locateFile']) {
  wasmBinaryFile = 'snake_engine.wasm';
  if (!isDataURI(wasmBinaryFile)) {
    wasmBinaryFile = locateFile(wasmBinaryFile);
  }
} else {
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  wasmBinaryFile = new URL('snake_engine.wasm', import.meta.url).href;
}
...
// end include: preamble.js
  ...
  var ___stack_pointer = new WebAssembly.Global({'value': 'i32', 'mutable': true}, 79760);
...
/** @type {function(...*):?} */
var _init_engine = Module["_init_engine"] = function() {
  return (_init_engine = Module["_init_engine"] = Module["asm"]["init_engine"]).apply(null, arguments);
};
