...
extern "C" {
    ...
    pub fn toxoid_entity_add_component(entity: ecs_entity_t, component: ecs_entity_t);
    pub fn toxoid_entity_add_tag(entity: ecs_entity_t, tag: ecs_entity_t);
    pub fn toxoid_entity_get_component(entity: ecs_entity_t, component: ecs_entity_t) -> i64;
    pub fn toxoid_entity_child_of(entity: ecs_entity_t, parent: ecs_entity_t);
    pub fn toxoid_entity_children(parent: ecs_entity_t) -> i64;
    pub fn toxoid_child_entities(iter: i64) -> *mut ecs_entity_t;
    pub fn toxoid_term_next(iter: i64) -> bool;
    pub fn toxoid_query_create() -> i64;
    pub fn toxoid_query_with(query_desc: i64, filter_index: u8, ids: *mut ecs_entity_t, components_count: i32) -> u8;
    pub fn toxoid_query_without(query_desc: i64, filter_index: u8, ids: *mut ecs_entity_t, components_count: i32) -> u8;
    pub fn toxoid_query_with_or(query_desc: i64, filter_index: u8, ids: *mut ecs_entity_t, components_count: i32) -> u8;
    pub fn toxoid_query_order_by(query_desc: i64, component_id: ecs_entity_t, callback: extern "C" fn(ecs_entity_t, i64, ecs_entity_t, i64) -> i32);
    pub fn toxoid_query_build(query_desc: i64) -> i64;
    pub fn toxoid_query_iter(query: i64) -> i64;
    pub fn toxoid_query_next(iter: i64) -> bool;
    // pub fn toxoid_query_count(iter: i64) -> i32;
    pub fn toxoid_query_field(
        iter: i64,
        term_index: i32,
        count: u32,
    ...
    pub fn toxoid_query_entity_list(iter: i64) -> &'static mut [Entity];
    pub fn toxoid_query_field_size(
        iter: i64,
        term_index: i32
    ) -> usize;
    ...
    pub fn toxoid_filter_create() -> i64;
    pub fn toxoid_filter_with(filter: i64, filter_index: u8, ids: *mut ecs_entity_t, components_count: i32) -> u8;
    pub fn toxoid_filter_without(filter: i64, filter_index: u8, ids: *mut ecs_entity_t, components_count: i32) -> u8;
    pub fn toxoid_filter_with_or(filter: i64, filter_index: u8, ids: *mut ecs_entity_t, components_count: i32) -> u8;
    pub fn toxoid_filter_build(filter: i64) -> i64;
    // pub fn toxoid_filter_term_count(filter: i64) -> i32;
    // pub fn toxoid_filter_term_size(filter: i64, term_index: i32) -> usize;
    // pub fn toxoid_filter_term_list(filter: i64, term_index: i32, count: u32) -> &'static mut [i64];
    // pub fn toxoid_filter_term_iter(filter: i64, term_index: i32) -> i64;
    // pub fn toxoid_filter_term_next(iter: i64) -> bool;
    // pub fn toxoid_filter_term_entity(iter: i64, count: u32, index: u32) -> ecs_entity_t;
    // pub fn toxoid_filter_term_entity_list(iter: i64) -> *mut ecs_entity_t;
    pub fn toxoid_iter_count(iter: i64) -> i32;
    #[cfg(all(target_arch="wasm32", target_os="emscripten"))]
    pub fn toxoid_component_cache_insert(type_id: SplitU64, component_id: SplitU64);
    #[cfg(any(not(target_arch="wasm32"), all(target_arch="wasm32", target_os="unknown")))]
    pub fn toxoid_component_cache_insert(type_id: u64, component_id: ecs_entity_t);
    ...
    #[cfg(any(not(target_arch="wasm32"), all(target_arch="wasm32", target_os="unknown")))]
    pub fn toxoid_network_entity_cache_remove(network_id: u64);
    pub fn toxoid_component_get_member_u8(component_ptr: i64, offset: u32) -> u8;
    pub fn toxoid_component_get_member_u16(component_ptr: i64, offset: u32) -> u8;
    pub fn toxoid_component_get_member_u32(component_ptr: i64, offset: u32) -> u32;
    #[cfg(all(target_arch="wasm32", target_os="emscripten"))]
    pub fn toxoid_component_get_member_u64(component_ptr: i64, offset: u32) -> SplitU64;
    #[cfg(any(not(target_arch="wasm32"), all(target_arch="wasm32", target_os="unknown")))]
    pub fn toxoid_component_get_member_u64(component_ptr: i64, offset: u32) -> ecs_entity_t;
    pub fn toxoid_component_get_member_i8(component_ptr: i64, offset: u8) -> i8;
    pub fn toxoid_component_get_member_i16(component_ptr: i64, offset: u8) -> i16;
    pub fn toxoid_component_get_member_i32(component_ptr: i64, offset: u32) -> i32;
    pub fn toxoid_component_get_member_i64(component_ptr: i64, offset: u32) -> i64;
    pub fn toxoid_component_get_member_f32(component_ptr: i64, offset: u32) -> f32;
    pub fn toxoid_component_get_member_f64(component_ptr: i64, offset: u32) -> f64;
    pub fn toxoid_component_get_member_bool(component_ptr: i64, offset: u32) -> bool;
    pub fn toxoid_component_get_member_u32array(component_ptr: i64, offset: u32) -> *mut u32;
    pub fn toxoid_component_get_member_f32array(component_ptr: i64, offset: u32) -> *mut f32;
    pub fn toxoid_component_get_member_string(
        component_ptr: i64,
        offset: u32,
        len: u32,
    ) -> i64;
    pub fn toxoid_component_set_member_u8(component_ptr: i64, offset: u32, value: u8);
    pub fn toxoid_component_set_member_u16(component_ptr: i64, offset: u32, value: u16);
    pub fn toxoid_component_set_member_u32(component_ptr: i64, offset: u32, value: u32);
    #[cfg(all(target_arch="wasm32", target_os="emscripten"))]
    pub fn toxoid_component_set_member_u64(component_ptr: i64, offset: u32, value: SplitU64);
    #[cfg(any(not(target_arch="wasm32"), all(target_arch="wasm32", target_os="unknown")))]
    pub fn toxoid_component_set_member_u64(component_ptr: i64, offset: u32, value: ecs_entity_t);
    pub fn toxoid_component_set_member_i8(component_ptr: i64, offset: u32, value: i8);
    pub fn toxoid_component_set_member_i16(component_ptr: i64, offset: u32, value: i16);
    pub fn toxoid_component_set_member_i32(component_ptr: i64, offset: u32, value: i32);
    pub fn toxoid_component_set_member_i64(component_ptr: i64, offset: u32, value: i64);
    pub fn toxoid_component_set_member_f32(component_ptr: i64, offset: u32, value: f32);
    pub fn toxoid_component_set_member_f64(component_ptr: i64, offset: u32, value: f64);
    pub fn toxoid_component_set_member_bool(component_ptr: i64, offset: u32, value: bool);
    pub fn toxoid_component_set_member_u32array(component_ptr: i64, offset: u32, value: *mut u32);
    pub fn toxoid_component_set_member_f32array(component_ptr: i64, offset: u32, value: *mut f32);
    pub fn toxoid_component_set_member_string(
        component_ptr: i64,
        offset: u32,
        len: u32,
    ...
    pub fn toxoid_progress(delta_time: f32) -> bool;
    pub fn toxoid_filter_children_init(parent: ecs_entity_t) -> i64;
    pub fn toxoid_filter_iter(filter: i64) -> i64;
    pub fn toxoid_filter_next(iter: i64) -> bool;
    pub fn toxoid_iter_entities(iter: i64) -> &'static [u64];
    pub fn toxoid_delete_entity(entity: ecs_entity_t);
    pub fn toxoid_entity_remove_component(entity: ecs_entity_t, component: ecs_entity_t);
    pub fn toxoid_is_valid(entity: ecs_entity_t) -> bool;
    pub fn toxoid_entity_has_component(
    ...
    pub fn toxoid_singleton_get(component: ecs_entity_t) -> i64;
    pub fn toxoid_singleton_add(component: ecs_entity_t);
    pub fn toxoid_singleton_remove(component: ecs_entity_t);
    #[cfg(all(target_arch="wasm32", target_os="emscripten"))]
    pub fn toxoid_prefab_create() -> SplitU64;
    ...
    pub fn toxoid_prefab_create() -> ecs_entity_t;
    pub fn toxoid_prefab_instance(prefab_high: u32, prefab_low: u32) -> SplitU64;
    pub fn toxoid_system_create(callback_closure: fn(&mut Iter)) -> i64;
    #[cfg(all(target_arch="wasm32", target_os="emscripten"))]
    pub fn toxoid_system_build(system_desc: i64) -> SplitU64;
    #[cfg(any(not(target_arch="wasm32"), all(target_arch="wasm32", target_os="unknown")))]
    pub fn toxoid_system_build(system_desc: i64) -> ecs_entity_t;
    pub fn toxoid_query_from_system_desc(query_desc: i64) -> i64;
    pub fn toxoid_network_send(network_messages: i64);
    #[cfg(all(target_arch="wasm32", target_os="emscripten"))]
    pub fn toxoid_net_send_components(
        entity_id: SplitU64,
        components: &[&dyn Component], 
    ...
    #[cfg(all(target_arch="wasm32", target_os="emscripten"))]
    pub fn toxoid_component_lookup(name: i64) -> SplitU64;
    #[cfg(any(not(target_arch="wasm32"), all(target_arch="wasm32", target_os="unknown")))]
    pub fn toxoid_component_lookup(name: i64) -> ecs_entity_t;
    #[cfg(all(target_arch="wasm32"))]
    pub fn toxoid_net_add_event(
        event_name: &str,
        callback: extern "C" fn(message: &crate::net::MessageEntity)
    ...
    pub fn toxoid_deserialize_entity_sync(entity_id: ecs_entity_t, components_serialized: &[crate::net::MessageComponent]);
    pub fn toxoid_make_c_string(string: &str) -> i64;
    pub fn toxoid_get_timestamp() -> SplitF64;
    pub fn gen_uuid() -> i64;
    // pub fn toxoid_engine_load_sprite(filename: &str, callback: extern "C" fn(&mut Entity)) -> *mut Entity;
    // pub fn toxoid_engine_load_worldmap(filename: &str, callback: extern "C" fn(&mut Entity)) -> *mut Entity;
    ...
    //     member_types_count: u32,
    // ) -> ecs_entity_t;
    // pub fn toxoid_create_vec() -> i64;
    // pub fn toxoid_vec_push(ptr: i64, value: i64);
    // pub fn toxoid_vec_drop(ptr: i64);
    // pub fn toxoid_vec_as_slice(ptr: i64) -> (*mut i64, i32);
    // pub fn toxoid_free_slice(ptr: i64, len: usize);
    // pub fn toxoid_entity_get_name(id: i32);
}