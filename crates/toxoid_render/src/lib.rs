...
pub trait Renderer2D {
    ...
    fn new() -> Self;
    // Create sprite
    fn create_sprite(width: u32, height: u32) -> &'static Sprite;
    // Blit sprite (draw sprite on another base sprite)
    fn blit_sprite(&self, sprite: &Sprite, sx: f32, sy: f32, sw: f32, sh: f32, dx: f32, dy: f32);
    // Resize sprite
    fn resize_sprite(&self, sprite: &Sprite, width: u32, height: u32);
    // Render sprite
    fn draw_sprite(&self, sprite: &Sprite, x: i32, y: i32);
    ...
    // Clear render target
    fn clear(&self, sprite: &Sprite, x: i32, y: i32, width: i32, height: i32);
    // Clear entire canvas
